...
#ifndef XMLTODBHANDLER_H
#define XMLTODBHANDLER_H

#include <QtXml>
#include "data/project.h"
#include "data/mergescenario.h"
#include "db/dbmanager.h"

namespace analysisimporter {

class XmlToDBHandler : public QXmlDefaultHandler
{
public:
    XmlToDBHandler();
    virtual ~XmlToDBHandler();
